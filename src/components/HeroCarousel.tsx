    ...
    <section className="relative h-[500px] md:h-[600px] lg:h-[700px] overflow-hidden">
      ...
      <div className="absolute top-20 right-10 z-30">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-accent text-accent-foreground rounded-full font-semibold hover:bg-accent/90 transition-colors shadow-lg"
        >
        ...
        <AnimatePresence>
          {showLinksMenu && (
            <motion.div
              ...
              className="absolute top-12 right-0 w-64 bg-white rounded-xl shadow-elevated border border-border overflow-hidden z-50"
            >
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="relative z-10 h-full container mx-auto px-4 flex items-center justify-end">
            ...
            >
              <h1 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl text-white leading-tight mb-4 drop-shadow-lg">
      ...
      <button
        onClick={prevSlide}
        className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-white/20 backdrop-blur-sm hover:bg-white/40 transition-all"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-white/20 backdrop-blur-sm hover:bg-white/40 transition-all"
